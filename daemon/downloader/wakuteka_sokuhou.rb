class Downloader::WakutekaSokuhou < Downloader::Base
  def dirname
    unless @dirname
      url =~ /http:\/\/blog\.livedoor\.jp\/wakusoku\/archives\/([0-9]+)\.html/
      @dirname = File.expand_path(File.join(base_path, "wakuteka_sokuhou" , $1))
